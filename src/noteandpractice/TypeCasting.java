...
public class TypeCasting {
	...
	public static void main(String[] args) {
		//In method overriding, methods execution is based on the runtime object. but the variable is based on the Reference
		C c = new C();
		...
		//execution is based on reference in Methods hiding, and variable access.
		System.out.println("");
		A a2 = new A();
		a2.m2();
...
//		//During type casting, new variable reference is create, object remains the same.
